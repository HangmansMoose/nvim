...
hi Normal guifg=#bcbcbc guibg=#151515 guisp=NONE gui=NONE ctermfg=250 ctermbg=235 cterm=NONE term=NONE
...
hi Cursor guifg=#151515 guibg=#bcbcbc guisp=NONE gui=NONE ctermfg=235 ctermbg=250 cterm=NONE term=reverse
...
hi ErrorMsg guifg=#af5f5f guibg=#151515 guisp=NONE gui=reverse ctermfg=131 ctermbg=235 cterm=reverse term=bold,reverse
...
hi IncSearch guifg=#151515 guibg=#af5f5f guisp=NONE gui=NONE ctermfg=235 ctermbg=131 cterm=NONE term=bold,reverse,underline
...
hi ModeMsg guifg=#87af87 guibg=#151515 guisp=NONE gui=reverse ctermfg=108 ctermbg=235 cterm=reverse term=bold
...
hi PmenuSel guifg=#151515 guibg=#5f8787 guisp=NONE gui=NONE ctermfg=235 ctermbg=66 cterm=NONE term=bold
...
hi Search guifg=#151515 guibg=#ffffaf guisp=NONE gui=NONE ctermfg=235 ctermbg=229 cterm=NONE term=reverse
...
hi SpellBad guifg=#af5f5f guibg=NONE guisp=#af5f5f gui=undercurl ctermfg=131 ctermbg=NONE
hi SpellCap guifg=#5fafaf guibg=NONE guisp=#5fafaf gui=undercurl ctermfg=73 ctermbg=NONE
hi SpellLocal guifg=#5f875f guibg=NONE guisp=#5f875f gui=undercurl ctermfg=65 ctermbg=NONE
hi SpellRare guifg=#ff8700 guibg=NONE guisp=#ff8700 gui=undercurl ctermfg=208 ctermbg=NONE
hi Statement guifg=#87afd7 guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE term=NONE
hi StatusLine guifg=#151515 guibg=#87875f guisp=NONE gui=NONE ctermfg=235 ctermbg=101 cterm=NONE term=bold,reverse
hi StatusLineNC guifg=#87875f guibg=#444444 guisp=NONE gui=NONE ctermfg=101 ctermbg=238 cterm=NONE term=bold,underline
hi StatusLineTerm guifg=#151515 guibg=#87875f guisp=NONE gui=NONE ctermfg=235 ctermbg=101 cterm=NONE term=NONE
...
hi TabLineSel guifg=#151515 guibg=#87875f guisp=NONE gui=NONE ctermfg=235 ctermbg=101 cterm=NONE term=bold,reverse
...
hi Visual guifg=#87afd7 guibg=#151515 guisp=NONE gui=reverse ctermfg=110 ctermbg=235 cterm=reverse term=reverse
...
hi WildMenu guifg=#151515 guibg=#87afd7 guisp=NONE gui=NONE ctermfg=235 ctermbg=110 cterm=NONE term=bold
